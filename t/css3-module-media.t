...
for (
    ...
    at_rule => {input => '@media all AND (min-resolution: 300dpi) And (min-resolution: 118dpcm) {}',
                ast => {"media_list" => ["media_query" => ["media" => "all", "media_expr" => {"media_feature" => "min-resolution", "expr" => ["term" => {"resolution" => 300}]}, "media_expr" => {"media_feature" => "min-resolution", "expr" => ["term" => {"resolution" => 118}]}]], "media_rules" => [], '@' => "media"},
    },
