...
for (
    ...
    selector   => {input => 'li:not(.pingback) .comment-content p:first-child:first-line',
                   ast => ["simple_selector" => ["element_name" => "li", "pseudo" => {"function" => {"ident" => "not", "args" => ["class" => "pingback"]}}, "class" => "comment-content"],
                           "simple_selector" => ["element_name" => "p", "pseudo" => {"class" => "first-child"}, "pseudo" => {"class" => "first-line"}]],
    },
