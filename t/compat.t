...
for (
    ...
    selector => {input => 'ol > li:first-child + li +li+ li+li',
                 ast => ["simple-selector" => ["element-name" => "ol"],
                         "combinator" => ">",
                         "simple-selector" => ["element-name" => "li", "pseudo" => {"class" => "first-child"}],
                         "combinator" => "+",
                         "simple-selector" => ["element-name" => "li"],
                         "combinator" => "+",
                         "simple-selector" => ["element-name" => "li"],
                         "combinator" => "+",
                         "simple-selector" => ["element-name" => "li"],
    ...
    selector => {input => 'A:first-letter',
                 ast => ["simple-selector" => {"element-name" => "a",
...
,
    ...
    ruleset => {input => 'A:link H1 { color: blue; }',
                ast => {"selectors" => ["selector" => ["simple-selector" => {"element-name" => "a", "pseudo" => {"class" => "link"}},
                                                       "simple-selector" => {"element-name" => "h1"}]],
                        "declarations" => {"color" => {"expr" => ["term" => 'blue']}}},
    },
    ruleset => {input => 'A:link,H1 { color: blue; }',
                ast => {"selectors" => ["selector" => ["simple-selector" => {"element-name" => "a", "pseudo" => {"class" => "link"}}],
                                        "selector" => ["simple-selector" => {"element-name" => "h1"}]],
                        "declarations" => {"color" => {"expr" => ["term" => 'blue']}}},
    },
    ruleset => {input => 'H1#abc { color: blue; }',
                ast => {"selectors" => ["selector" => ["simple-selector" => {"element-name" => "h1", "id" => "abc"}]],
                        "declarations" => {"color" => {"expr" => ["term" => 'blue']}}},
    },
    ruleset => {input => 'A.external:visited { color: blue; }',
                ast => {"selectors" => ["selector" => ["simple-selector" => {"element-name" => "a", "class" => "external", "pseudo" => {"class" => "visited"}}]],
                        "declarations" => {"color" => "expr" => ["term" => 'blue']}},
    },
    simple-selector => {input => 'A[ href ]',
                        ast => {"element-name" => "a", "attrib" => {"ident" => "href"}},
                        css1 => {
                            parse => 'A', ast => {"element-name" => "a"},
                        },
    },
    simple-selector => {input => 'a[href~="foo"]',
                        ast => {"element-name" => "a", "attrib" => {"ident" => "href", "attribute-selector" => "~=", "string" => "foo"}},
                        css1 => {
                            parse => 'a', ast => {"element-name" => "a"},
                        },
    },
    ...
    stylesheet => {input => "\@import 'foo';\nH1 \{ color: blue; \};\n@charset 'bazinga';\n\@import 'too-late';\nH2\{color:green\}",
                   ast => ["import" => {"string" => "foo"},
                           "ruleset" => {"selectors" => ["selector" => ["simple-selector" => {"element-name" => "h1"}]],
                                         "declarations" => {"color" => {"expr" => ["term" => 'blue']}},
                           "ruleset" => {"selectors" => ["selector" => ["simple-selector" => {"element-name" => "h2"}]],
                                         "declarations" => {"color" => {"expr" => ["term" => 'green']}}}}],
                   warnings => [
