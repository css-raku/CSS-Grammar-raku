...
for (
    ...
    at_rule => {input => 'media print {body{margin: 1cm}}',
                ast => {"media_list" => ["media_query" => ["media" => "print"]], "media_rules" => ["ruleset" => {"selectors" => ["selector" => ["simple_selector" => ["element_name" => "body"]]], "declarations" => ["declaration" => {"property" => "margin", "expr" => ["term" => 1]}]}], '@' => 'media'},
                css1 => {skip_test => True},
    },
    at_rule => {input => 'page :first { margin-right: 2cm }',
                ast => {"page" => "first", "declarations" => ["declaration" => {"property" => "margin-right", "expr" => ["term" => 2]}], '@' => 'page'},
                css1 => {skip_test => True},
    },
